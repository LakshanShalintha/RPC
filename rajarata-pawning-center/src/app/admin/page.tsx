          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <div className="w-full bg-green-500/20 px-4 py-2 rounded-full flex items-center justify-center gap-2 mb-3">
                  <span className="text-green-400">●</span>
                  <span className="text-green-200 font-semibold">{loading ? 'Loading...' : `${sliders.length} Images`}</span>
                </div>
